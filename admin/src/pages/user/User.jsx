        ...
        <div className="userShow">
          ...
          <div className="userShowBottom">
            ...
            <div className="userShowInfo">
              ...
              <span className="userShowInfoTitle">Morawy 15 | Poland</span>
            </div>
          </div>
        </div>
          ...
          <form className="userUpdateForm">
            <div className="userUpdateLeft">
              <div className="userUpdateItem">
                ...
                <input type="text" placeholder="ann@gmail.com" className="userUpdateInput" />
              </div>
              <div className="userUpdateItem">
                <label>Full Name</label>
                <input type="text" placeholder="Anna Małecka" className="userUpdateInput" />
              </div>
              <div className="userUpdateItem">
                <label>Email</label>
