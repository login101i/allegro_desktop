	...
	return (
		<Flex column>
			...
			<Text wrap style={{ padding: "20px" }}>
				Nadaj przesyłkę w dowolnym paczkomacie InPost! Za wysyłkę zapłacisz
				zawsze 8,99 zł, niezależnie od rozmiaru paczki. Możesz zwiększyć
				atrakcyjność oferty obniżając w polu powyżej kwotę, którą zapłaci Ci za
				tę wysyłkę kupujący.
			</Text>
