			...
			<Flex column>
				...
				>
					...
					<Text wrap color="grey">
						Widoczne ślady używania lub uszkodzenia, które zostały uwzględnione
						w opisie tego przedmiotu i/lub na zdjęciach.
					</Text>
				</ProductState>
				<ProductState
				...
				>
					...
					<Text wrap color="grey">
						W bardzo dobrym stanie technicznym i wizualnym. Nie nosi śladów
						używania lub są one znikome.
					</Text>
				</ProductState>
				<ProductState
				...
				>
					...
					<Text wrap color="grey">
						Fabrycznie nowy, nieużywany, nieuszkodzony, zapakowany w oryginalne
