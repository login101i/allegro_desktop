...
const ProductSchema = new mongoose.Schema(
	{
		...
		img: [
			{
				url: {
					type: String,
					default: 'https://www.cashless.pl/system/uploads/ckeditor/pictures/2130/content_allegro_stara_ikona.jpg',
				},
			},
		],
		...
		category: {
			...
			enum: {
				values: ['Laptopy', 'Telefony', 'Perfumy', 'Supermarket', 'AGD', 'Pupil'],
		...
		seller: {
			type: String,
			required: [false, 'Proszę podać nazwę sprzedawcy'],
			default: 'Maciej',
		},
		stock: {
			type: Number,
